...
function FooterSection() {
  console.log(footerExtraSections)
  return (
    <div>
      <footer className="hidden md:flex text-[#87878a]">
        <div className="mx-4 my-2 px-4 py-2 w-full">
          ...
          />
          <div>
            <div className="text-sm my-8 py-4">
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">Flipkart Plus</h2>
              ...
              members earn 2 supercoins. Early access during sales and shopping
              festivals, exchange offers and priority customer service are the
              top benefits to a Flipkart Plus member. In short, earn more when
              you shop more!
              <br />
              <br />
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">No Cost EMI</h2>
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">EMI on Debit Cards</h2>
              ...
              <h2 className="text-md font-medium">Mobile Phones</h2>
              ...
              <b className="px-1">the Flipkart Complete Mobile Protection</b> covers a
              ...
              <b className="px-1">Back To College Store</b>
              segregates laptops purpose wise (gaming, browsing and research,
              project work, entertainment, design, multitasking) with
              recommendations from top brands and industry experts, facilitating
              a shopping experience that is quicker and simpler.
              <br />
              <br />
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">Large Appliances</h2>
              ...
              <b className="px-1">Dependable TV and Appliance Store</b>
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">Small Home Appliances</h2>
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">Lifestyle</h2>
              Flipkart, <b className="px-1">'India ka Fashion Capital'</b>
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">Home and Furniture</h2>
              ...
              Well, our
              <b className="px-1">Durability Certified Furniture Store</b>
              ...
              you receive only the best-quality furniture.
              <b className="px-1">Be FurniSure</b>
              , always. Names to look out for are Nilkamal, Godrej Interio,
              Urban Ladder, HomeTown, Durian and Perfect Homes.
              <br />
              <br />
              <h2 className="text-md font-medium">Baby and Kids</h2>
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">Books, Sports and Games</h2>
              ...
              <br />
              <br />
              <h2 className="text-md font-medium">Grocery/Supermart</h2>
              Launching into the grocery vertical, Flipkart introduces
              <b className="px-1">Supermart</b>
              ...
              our
              <b className="px-1">1 Rupee Store</b>
          ...
          <div className="bg-black text-[12px] px-16 py-10 flex-col ">
            ...
            <div className="flex flex-wrap gap-10 border-b-0 lg:border-l lg:border-[#454d5e] pl-10">
              ...
              {/* Copy rights content */}
         <div className="flex px-8 text-white border-b-0 lg:border-t lg:border-[#454d5e] py-5">
