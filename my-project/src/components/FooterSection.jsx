import { jsonLinks } from "../items/ItemsArray";
import MostSearchedCard from "./MostSearchedCard";
import { footerLinkCategories } from "../items/ItemsArray";
import { footerExtraSections } from "../items/ItemsArray";
      ...
      <footer className="hidden md:flex text-[#87878a]">
        <div className="mx-4 my-2 px-4 py-2">
          ...
          <div className="w-full">
            <div className="bg-black text-[12px] px-5 py-10 flex justify-between items-center ">
             <div className="flex">
              {footerLinkCategories.map((section, index) => (
                <div key={index}>
                  <h3 className="text-[#878787] ">{section.title}</h3>
              ...
              <div >
                {footerExtraSections.map((section) => (
                 <div>
                  <div className="flex">
                    <div >
                      <h3>{section.title}</h3>
