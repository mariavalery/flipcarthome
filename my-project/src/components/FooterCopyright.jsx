    ...
    <div>
        {/* Main footer content */}
          <div className="bg-black text-[12px] px-16 py-10 flex-col ">
            ...
            <div className="flex flex-wrap gap-10 border-b-0 lg:border-l lg:border-[#454d5e] md:pl-10">
              ...
              {/* Copy rights content */}
         <div className="flex md:px-8 text-white border-b-0 lg:border-t lg:border-[#454d5e] pt-5 mt-3">
            <div className="flex gap-8 mx-5">
             {endFooterIcons.map((item)=>(
              <div className="flex gap-2" key={item.id}>
                <img src={item.icon} className="md:h-4 md:w-4"/>
